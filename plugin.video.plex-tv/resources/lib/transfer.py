...
WINDOW_UPSTREAM = 'plex-tv.result.upstream'.encode('utf-8')
WINDOW_DOWNSTREAM = 'plex-tv.result.downstream'.encode('utf-8')
WINDOW_COMMAND = 'plex-tv.command'.encode('utf-8')
