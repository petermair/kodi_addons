...
def directory_item(label, path, folder=True):
    ...
    listitem.setThumbnailImage(
        "special://home/addons/plugin.video.plex-tv/icon.png")
    listitem.setArt(
        {"fanart": "special://home/addons/plugin.video.plex-tv/fanart.jpg"})
    listitem.setArt(
        {"landscape":"special://home/addons/plugin.video.plex-tv/fanart.jpg"})
...
def extra_fanart(plex_id, plex_path):
    ...
    if not plex_id:
        if "plugin.video.plex-tv" in plex_path:
