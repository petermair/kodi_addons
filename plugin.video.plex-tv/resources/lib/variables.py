...
DB_PLEX_COPY_PATH = try_decode(xbmc.translatePath("special://database/plex_copy.db"))
...
ADDON_TYPE = {
    PLEX_TYPE_MOVIE: 'plugin.video.plex-tv.movies',
    PLEX_TYPE_CLIP: 'plugin.video.plex-tv.movies',
    PLEX_TYPE_EPISODE: 'plugin.video.plex-tv.tvshows',
    PLEX_TYPE_SEASON: 'plugin.video.plex-tv.tvshows',
    PLEX_TYPE_SHOW: 'plugin.video.plex-tv.tvshows',
    PLEX_TYPE_SONG: 'plugin.video.plex-tv',
    PLEX_TYPE_ALBUM: 'plugin.video.plex-tv',
    PLEX_TYPE_ARTIST: 'plugin.video.plex-tv',
    PLEX_TYPE_PLAYLIST: 'plugin.video.plex-tv'
}
